...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Authentication app</h1>\n  <p class=\"lead\">Welcome to our custom Mean authetication application built from scratch</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a><a class=\"btn btn-default\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n \n<div class=\"row\">\n  <div class =\"col-md-4\">\n    <h3>Express backend</h3>\n    <p>A rock solid Node.js/Express server using Mongoose to orginize models and query</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p> Angular-CLI to generate components, services and more. Local dev server and easy</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Full featured authentication using Json web tokens. Login and store user data</p>\n  </div>"
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show('Aomething went wrong', { cssClass: 'alert-danger', timeout: 3000 });
